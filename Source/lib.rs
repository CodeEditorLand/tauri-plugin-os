...
/// Returns a string describing the specific operating system in use, see
/// [std::env::consts::OS].
pub fn platform() -> &'static str { std::env::consts::OS }

/// Returns the current operating system version.
pub fn version() -> Version { os_info::get().version().clone() }
...
pub fn family() -> &'static str { std::env::consts::FAMILY }

/// Returns the current operating system architecture, see
/// [std::env::consts::ARCH].
pub fn arch() -> &'static str { std::env::consts::ARCH }

/// Returns the file extension, if any, used for executable binaries on this
/// platform. Example value is `exe`, see [std::env::consts::EXE_EXTENSION].
pub fn exe_extension() -> &'static str { std::env::consts::EXE_EXTENSION }

/// Returns the current operating system locale with the `BCP-47` language tag.
